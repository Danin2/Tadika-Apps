...
// Pelafalan huruf yang lebih konsisten
...
// ============ BUAH ============
const buahItems = [
  { fileName: 'fruits_apel.mp3',     teks: 'Apel' },
  { fileName: 'fruits_pisang.mp3',   teks: 'Pisang' },
  { fileName: 'fruits_jeruk.mp3',    teks: 'Jeruk' },
  { fileName: 'fruits_semangka.mp3', teks: 'Semangka' },
  { fileName: 'fruits_mangga.mp3',   teks: 'Mangga' },
];

// ============ HEWAN ============
const hewanItems = [
  { fileName: 'animals_kucing.mp3',   teks: 'Kucing' },
  { fileName: 'animals_singa.mp3',    teks: 'Singa' },
  { fileName: 'animals_gajah.mp3',    teks: 'Gajah' },
  { fileName: 'animals_jerapah.mp3',  teks: 'Jerapah' },
  { fileName: 'animals_monyet.mp3',   teks: 'Monyet' },
];

// ============ GABUNGKAN SEMUA ============
const allItems = [...hurufItems, ...kataItems, ...angkaItems, ...buahItems, ...hewanItems];
